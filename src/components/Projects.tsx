...
const Projects: FC<Props> = () => {
    const gh_icon = (
        <svg viewBox="0 0 128 128" className="max-w-full w-8">
            <g fill="#181616" className="fill-gray-100">
                <path
                    fillRule="evenodd"
                    clipRule="evenodd"
    ...
    const projects: Project[] = [
        ...
        },
        {
            ...
            description:
                "Can you remember which cards have already been picked?",
    ...
    projects.forEach((proj) =>
        projs_DOM.push(
            <div
                className="flex flex-col relative min-w-full overflow-hidden
                group shadow-gray-200 shadow-[0_0_30px_-15px]
                "
            ...
            >
                ...
                <div
                    className="absolute all-0 bg-transparent backdrop-blur-xl overflow-hidden 
                     bottom-full md:group-hover:bottom-0 transition-[bottom] duration-500 ease-in
                     "
                >
                    <div className="main_info">
                        ...
                        <div className="mx-auto max-w-fit text-lg px-4 text-center">
                            {proj.description}
                        </div>
    ...
    return (
        ...
        >
            ...
            <div className="grid grid-cols-auto-fit-300 gap-10">
                {projs_DOM.map((proj) => proj)}
            </div>
        </section>
    );
};
